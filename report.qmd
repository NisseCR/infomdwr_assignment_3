...
# Fit the full model 
full.model <- lm(score ~., data = data_train)
...
# Train the model
model1 <- train(
  score ~ sex + age + Medu + Mjob + Mjob + Mjob + Mjob + studytime + failures + schoolsup + famsup + romantic + goout + health,
  data = data_train,
  method = "lm",
